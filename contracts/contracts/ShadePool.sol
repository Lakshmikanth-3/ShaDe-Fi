 ...
 *         Use euint64 for maximum compatibility with the Zama Sepolia standard.
 */
contract ShadePool is SepoliaZamaFHEVMConfig {
    ...
    function _computeOut(
        ...
        euint64 denominator = TFHE.add(reserveIn, amountIn);
    ...
    function removeLiquidity(
        ...
        euint64 amountAOut = TFHE.div(TFHE.mul(_reserveA, burnShares), _totalShares);
        euint64 amountBOut = TFHE.div(TFHE.mul(_reserveB, burnShares), _totalShares);
